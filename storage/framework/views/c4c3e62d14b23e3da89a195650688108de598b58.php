                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['userCount']); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['collegeCount']); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['degreeCount']); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['questionCount']); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['answerCount']); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-lg-2">
                            <div class="mini-stat clearfix bx-shadow">
                                ...
                                <div class="mini-stat-info text-right text-muted">
                                    <span class="counter"><?php echo e($count['resultCount']); ?></span>
