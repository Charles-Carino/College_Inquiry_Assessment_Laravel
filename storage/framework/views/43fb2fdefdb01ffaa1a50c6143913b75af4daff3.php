                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                    <?php $__currentLoopData = $college; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="gradeX">
                                      <td><?php echo e($key->collegeCode); ?></td>
                                      <td><?php echo e($key->collegeName); ?></td>
                                      <td><?php echo nl2br($key->collegeAboutInfo); ?></td>
                                      <td><?php echo e($key->collegeDean); ?></td>
                                      <td><?php echo e($key->collegeEmail); ?></td>
                                      <td><?php echo e($key->collegePhoneNumber); ?></td>
                                      <td class="actions">
