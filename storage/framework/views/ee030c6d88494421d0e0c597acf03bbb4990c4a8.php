                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table table-bordered table-striped" id="datatable-editable">
                                    ...
                                    <tbody>
                                       <?php $__currentLoopData = $degree; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <tr class="gradeX">
                                         <td><?php echo e($key->collegeName); ?></td>
                                         <td><?php echo e($key->collegeCode); ?></td>
                                         <td><?php echo e($key->degreeCode); ?></td>
                                         <td><?php echo e($key->degreeDesc); ?></td>
                                         <td><?php echo nl2br(e($key->degreeJobs)); ?></td>
                                         <td class="actions">
