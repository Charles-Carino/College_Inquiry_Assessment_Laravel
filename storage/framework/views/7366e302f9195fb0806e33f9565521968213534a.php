...
<!-- query for college -->
        <div class="row">
            <?php $__currentLoopData = $c; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-item">
                    <h3><?php echo e($col->collegeName); ?></h3>
                   <p><?php echo e($col->collegeAboutInfo); ?>...</p>
                  </div>
                </div>
      ...
      <div id="more-colleges"class="container">
          <a class="a-colleges" href="/colleges">click here to learn more</a>
      </div>
    </section>
    <!---->
    <!---->
    <section id="feature" class="section-padding wow fadeIn delay-05s">
      ...
      <div id="more-colleges"class="container">
          <a class="a-colleges" href="/about">click here to learn more...</a>
      </div>
    </section>
