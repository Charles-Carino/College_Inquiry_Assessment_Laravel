                ...
                @else
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <img src="../img/uploads/{{Auth::user()->avatar}}" style="width:32px;length:32px; border-radius:50%;">
                            {{ Auth::user()->name }} <span class="caret"></span>
                        </a>

                        <ul class="dropdown-menu" role="menu">
                            @if(Auth::user()->userType == 'user')
                                <li><a href="/userProfile/{{Auth::user()->id}}"><i class="md md-check"></i>User Profile</a></li>
                            @else
                                <li><a href="/userProfile/{{Auth::user()->id}}"><i class="md md-check"></i>User Profile</a></li>
